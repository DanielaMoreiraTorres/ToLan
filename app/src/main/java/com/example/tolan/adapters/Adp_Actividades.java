...
public class Adp_Actividades extends RecyclerView.Adapter<Adp_Actividades.ViewHolder> {
    ...
    public Adp_Actividades(ArrayList<ModelActivity> listaActividades, Fragment fragment) {
    ...
    @NonNull
    @Override
    public Adp_Actividades.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull Adp_Actividades.ViewHolder holder, int position) {
