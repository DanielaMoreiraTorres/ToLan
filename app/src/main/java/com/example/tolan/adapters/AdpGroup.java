...
public class AdpGroup extends RecyclerView.Adapter<AdpGroup.MyViewHolder>
        implements View.OnClickListener {
    private static final int TYPE_HEADER = 0;
    private static final int TYPE_LIST = 0;

    public AdpGroup(ArrayList<ModelGroup> mLista) {
        this.mLista = mLista;
    }
    ...
    @NonNull
    @Override
    public AdpGroup.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view;
    ...
    @Override
    public void onBindViewHolder(@NonNull AdpGroup.MyViewHolder holder, int position) {
        try {
