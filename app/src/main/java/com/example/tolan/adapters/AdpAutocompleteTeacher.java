...
public final class AdpAutocompleteTeacher extends ArrayAdapter<ModelUser> {

    private List<ModelUser> listaFull;

    public AdpAutocompleteTeacher(@NonNull Context context, @NonNull List<ModelUser> lista) {
