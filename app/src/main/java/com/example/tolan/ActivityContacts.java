...
import com.example.tolan.adapters.AdpContacts;
...
public class ActivityContacts extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AdpContacts.showShimmer = true;
        List<ClssContact> list = new ArrayList<ClssContact>();
        AdpContacts adpContact = new AdpContacts(list);
        rcvContacts.setAdapter(adpContact);

        ClssContact c1 = new ClssContact("Burbano Parraga Cristhian","+593980395656","cristhian.burbano2016@uteq.edu.ec");
        ClssContact c2 = new ClssContact("Jaya Puruncaja Ruben","+593987943667","ruben.jaya2015@uteq.edu.ec");
        ClssContact c3 = new ClssContact("Moreira Torres Daniela","+593967037621","daniela.moreira2015@uteq.edu.ec");
        ClssContact c4 = new ClssContact("Zambrano Aroca Bryan","+593967667147","bryan.zambrano@uteq.edu.ec");

        final List<ClssContact> finalList = new ArrayList<ClssContact>();
        finalList.add(c1);
        finalList.add(c2);
        finalList.add(c3);
        finalList.add(c4);
        ...
        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                AdpContacts adpContacts = new AdpContacts(finalList);
